...
const VisitorNotificationsMap = {
    ...
    PLANNED_VISITOR_ALLOW_IN: {
        ...
        data: {
            screen: "Visitors",
            params: JSON.stringify({ screenTab: "Planned Visitors", visitor_id: "73" }),
        },
    ...
    PLANNED_VISITOR_COMPLETED: {
        ...
        message: "Planned visitor #[visitor_name] has checked out from the premises.",
        data: {
            screen: "Visitors",
    ...
    UNPLANNED_VISITOR_ACTION_REQUIRED: {
        ...
        message: "Security has raised an unplanned visitor request. Please respond with an action.",
        data: {
            screen: "Visitors",
            params: JSON.stringify({ screenTab: "Unplanned Visitors", visitor_id: "73" }),
        },
    ...
    UNPLANNED_VISITOR_COMPLETED: {
        ...
        message: "Unplanned visitor #[visitor_id] has checked out from the premises.",
        data: {
            screen: "Visitors",
            params: JSON.stringify({ screenTab: "Completed", visitor_id: "73" }),
        },
