...
// testing react native notification
...
const parcelNotificationMap = {
  PARCEL_CREATED: {
    ...
    message:
      "You have a delivery: Biriyani Delivery by Ramesh. Please respond: Allow, Leave at Gate, or Deny.",
    data: {
      screen: "My Parcels",
  ...
  PARCEL_ALLOWED: {
    ...
    message:
      "User of [flat_no] [block_name] has allowed the delivery. Please proceed with check-in.",
    data: {
  ...
  PARCEL_DELIVERED_RETURNED: {
    ...
    message:
      "The parcel #[parcel_id] has been delivered and the delivery person has exited.",
    data: {
      screen: "My Parcels",
      params: JSON.stringify({
        ScreenTab: "Delivered Parcels",
  ...
  PARCEL_LEAVE_AT_GATE: {
    ...
    message:
      "User of [flat_no] [block_name] requested the parcel be left at the gate. Please store it safely.",
    data: {
      screen: "My Parcels",
      params: JSON.stringify({
        ScreenTab: "Incoming Parcels",
  ...
  PARCEL_DENIED: {
    ...
    message:
      "User of [flat_no] [block_name] denied the parcel #[parcel_id]. Please return it to the delivery person.",
    data: {
      screen: "My Parcels",
...
const AnalogueLogo =
  "https://www.analogueitsolutions.com/assets/analogueitsolution_logo-BVdZYf9n.png";
